...
## Chart
```{raw} html
<iframe src="../../_static/Omar-Anabtawi--finm32900_hw4_fedwatch/fedwatch_latest_forecast.html" height="500px" width="100%"></iframe>

<p style="text-align: center;">Sources: </p>
```
[Full Screen Chart](../download_chart/Omar-Anabtawi--finm32900_hw4_fedwatch/fedwatch_latest_forecast.html)
...
| Seasonal Adjustment    |                                     |
| Units                  | Probability (%)                                                  |
| HTML Chart             | [HTML](../download_chart/Omar-Anabtawi--finm32900_hw4_fedwatch/fedwatch_latest_forecast.html)    |
